...
// Read the HTML file
const html = fs.readFileSync('C:/Users/khy/Documents/workspace/dev_docs/ko/dev4/authv4/login-helper.html', 'utf8');

// Load the HTML into Cheerio
const $ = cheerio.load(html);

const table = $('#idpconnect-guide-text').next('table');
...
fs.writeFileSync('C:/Users/khy/Documents/workspace/dev_docs/ko/dev4/authv4/login-helper-TMP.html', $.html());
